 ...
 */
function removeSpaceAndPunct(str) {
 ...
 * @returns {boolean} 是否匹配
 */
function matchIgnoreSpacePunct(str1, str2) {
 ...
 */
function fuzzyMatch(keyValue, keyMap, strategies, levenshteinThreshold = 1) {
 ...
 */
function matchRow(rowB, rowIndex, keyMap, keyColumnB, selectedColumns, stats, strategies = {}, levenshteinThreshold = 1) {
 ...
 */
function executeMatchRuleChain(fileBData, fileAData, matchRules, selectedColumns, stats) {
...
module.exports = {
  ...
  matchIgnoreCase,
  removeSpaceAndPunct,
  matchIgnoreSpacePunct,
  fuzzyMatch,
  executeMatchRuleChain,
  MATCH_TYPES,
  FUZZY_STRATEGIES,
};
