...
function App() {
  ...
  const [useMatchRuleChain, setUseMatchRuleChain] = useState(false);
  const [matchRules, setMatchRules] = useState([createDefaultMatchRule(1)]);
